...
int32_t *execute(method_t *method, local_variable_t *locals, class_file_t *clazz)
{
    ...
    while (pc < code.code_length) {
        ...
        case i_iload_3: {
            ...
            memcpy(&loaded, locals[param].entry, sizeof(int32_t));
        ...
        case i_istore: {
            ...
            memcpy(locals[param].entry, &stored, sizeof(int32_t));
            pc += 2;
        } break;
        ...
        case i_iinc: {
            ...
            int32_t value;
            memcpy(&value, locals[i].entry, sizeof(int32_t));
            value += b;
            memcpy(locals[i].entry, &value, sizeof(int32_t));
            pc += 3;
        } break;
